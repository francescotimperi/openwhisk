...
private[cosmosdb] object SubjectViewMapper extends CosmosDBViewMapper {
  ...
  private def queryForMatchingSubjectOrNamespace(
    ddoc: String,
    view: String,
    startKey: List[Any],
    endKey: List[Any],
